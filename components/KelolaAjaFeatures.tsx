...
export default function KelolaAjaFeatures() {
  ...
  const fallbackFeaturesData = t.kelolaAjaFeatures || {
      ...
      <section className="py-10 lg:py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center min-h-[200px]">
            <div className="inline-block animate-spin rounded-full h-10 w-10 border-b-2 border-[#0498da]" />
          </div>
        </div>
      </section>
    );
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollAnimation direction="fade" delay={0} duration={600}>
          <div className="text-center mb-8 lg:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-gray-900">{featuresData.title}</h2>
          </div>
        </ScrollAnimation>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 max-w-7xl mx-auto">
          {featuresData.features.map((feature, index) => {
            ...
            return (
              <ScrollAnimation key={index} direction="up" delay={index * 80} duration={500} className="flex">
                <div className="bg-white rounded-lg p-4 lg:p-5 border border-gray-200 hover:border-primary-400 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-primary-500/3 to-secondary-500/3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
