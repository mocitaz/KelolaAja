      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {currentValues.map((value) => (
            <AdminCard key={value.letter} className="hover:shadow-lg transition-shadow">
              <div className="p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 mb-1">Description (ID)</p>
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-900">
                    Edit {editingValue.letter} - {activeTab === 'agile' ? 'AGILE' : 'IMPACT'}
                  </h3>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-semibold text-gray-900 border-b pb-2">Bahasa Indonesia</h4>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({ ...formData, id: { ...formData.id, subtitle: e.target.value } })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#0498da]"
                      />
                    </div>
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => setFormData({ ...formData, id: { ...formData.id, description: e.target.value } })}
                        rows={5}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#0498da]"
                      />
                    </div>
                  ...
                  {/* English */}
                  <div className="space-y-4">
                    <h4 className="text-sm font-semibold text-gray-900 border-b pb-2">English</h4>
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">Title</label>
                      <input
                        type="text"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({ ...formData, en: { ...formData.en, subtitle: e.target.value } })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#0498da]"
                      />
                    </div>
                    <div>
